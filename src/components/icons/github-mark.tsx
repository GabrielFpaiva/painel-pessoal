...
/**
 * O lucide 1.x tirou os ícones de marca do pacote. Uma marca só não justifica
 * outra dependência de ícones, então o octocat mora aqui.
 *
 * Assinatura igual à do `LucideIcon` (herda `size` por `className`), para
 * entrar na mesma lista de navegação sem tratamento especial.
 */
